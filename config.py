...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = SQLALCHEMY_DATABASE_URI = "sqlite:///" + os.path.join(os.path.dirname(os.path.abspath(__file__)), "hiresphere.db")
    ...
    # Redis DB 1 → Flask-Cache (separate DB to avoid key collisions)
    ...
    CACHE_KEY_PREFIX      = "hs:"  # namespace all cache keys
    ...
    CELERYBEAT_SCHEDULE = {
        ...
        "monthly-activity-report": {
            ...
            "schedule": crontab(hour=18, minute=49, day_of_month=11),
        },
    }
